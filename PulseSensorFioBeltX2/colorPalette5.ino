#include "LPD8806.h"
#include "SPI.h"
//kristin neidlinger update from chris jeffries code
...
// for led strip
# if defined(USB_SERIAL) || defined(USB_SERIAL_ADAFRUIT)PulseSensorFioBeltX2.inoPulseSensorFioBeltX2.inoPulseSensorFioBeltX2 PulseSensorFioBeltX2 
int dataPin = 2;
int clockPin = 1;
#else 
...
uint32_t setColor(int bpm) {
  ...
  int range = map(bpm, pulseRateMin, pulseRateMax, 0, 5);
